...
(1, '1', 1,  '2023-02-01', '2023-04-6 15:00:00', 10.00,3),
...
(1, 'Clase de yoga', 'Clase de yoga para todos los niveles', 20, 20, 5.00, 10.00, '2023-04-19', '2023-05-12', 'Yoga', 3, 3),
(2, 'Partido de fútbol', 'Solteros vs Casados', 22, 22, 0.00, 5.00, '2023-04-19', '2023-05-06', 'Fútbol', 6, 1),
(3, 'Clase de natación', 'Clase de natación para gente que no sabe nadar', 15, 15, 10.00, 15.00, '2023-04-19', '2023-05-10', 'Natación', 1, 3),
(4, 'Entrenamiento de boxeo', 'Entrenamiento de boxeo para todos los niveles', 12, 12, 7.00, 12.00, '2023-04-19', '2023-05-05', 'Boxeo', 3, 3),
(5, 'Clase de baile', 'Clase de baile para principiantes', 25, 25, 8.00, 13.00, '2023-04-19', '2023-05-05', 'Baile', 3, 1),
(6, 'Partido pádel', 'Pepe se enfrenta a tí', 4, 0, 8.00, 13.00, '2023-04-19', '2023-05-10', 'Pádel', 4, 3);


INSERT INTO inscripciones(id_inscripcion, dni_clientes, id_actividades, fecha) VALUES
(1,'11111111A', 1, '2023-2-23 17:00:00'), 
(2,'11111111A', 2,'2023-2-24 18:00:00'), 
(3,'55555555E', 3,'2023-2-25 19:00:00'),
(4,'77777777G', 1, '2023-2-26 20:00:00'),
...
(7,'44444444D', 6, '2023-04-20 10:00:00', 'sí');
