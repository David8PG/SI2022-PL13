...
(1, 'Clase de yoga', 'Clase de yoga para todos los niveles', 20, 20, 5.00, 10.00, '2023-04-12', '2023-04-31', 'Yoga', 3, 3),
(2, 'Partido de fútbol', 'Solteros vs Casados', 22, 22, 0.00, 5.00, '2023-04-12', '2023-04-31', 'Fútbol', 6, 1),
(3, 'Clase de natación', 'Clase de natación para gente que no sabe nadar', 15, 15, 10.00, 15.00, '2023-04-12', '2023-04-31', 'Natación', 1, 3),
(4, 'Entrenamiento de boxeo', 'Entrenamiento de boxeo para todos los niveles', 12, 12, 7.00, 12.00, '2023-04-12', '2023-04-05', 'Boxeo', 3, 3),
(5, 'Clase de baile', 'Clase de baile para principiantes', 25, 25, 8.00, 13.00, '2023-04-12', '2023-04-05', 'Baile', 3, 1),
(6, 'Partido pádel', 'Pepe se enfrenta a tí', 4, 0, 8.00, 13.00, '2023-04-12', '2023-04-05', 'Pádel', 4, 3);
