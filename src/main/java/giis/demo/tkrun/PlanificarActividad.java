			...
			public void actionPerformed(ActionEvent e) {
				...
				if (comboBox_4.getSelectedIndex() >= comboBox_4_1.getSelectedIndex() + 1) {
					JOptionPane.showMessageDialog(frmPlanificarActividad,
							"No se puede añadir esa sesión, la hora de inicio tiene que ser anterior a la posterior.",
					...
					textPane.setText("Los " + textPane.getText()
							+ comboBox_3.getModel().getElementAt(comboBox_3.getSelectedIndex()) + " desde las "
							+ comboBox_4.getModel().getElementAt(comboBox_4.getSelectedIndex()) + " hasta las "
							+ comboBox_4_1.getModel().getElementAt(comboBox_4_1.getSelectedIndex()) + "\n");
				}
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (textField.getText().equals("")) {
					...
					JOptionPane.showMessageDialog(frmPlanificarActividad,
							"La actividad no se ha creado. Debes introducir una descripción.", "Error",
							JOptionPane.ERROR_MESSAGE);
				} else if (textField_2.getText().equals("")) {
					JOptionPane.showMessageDialog(frmPlanificarActividad,
							"La actividad no se ha creado. Debes introducir un precio para socios. ", "Error",
							JOptionPane.ERROR_MESSAGE);
				} else if (textField_3.getText().equals("")) {
					JOptionPane.showMessageDialog(frmPlanificarActividad,
							"La actividad no se ha creado. Debes introducir un precio para no socios.", "Error",
							JOptionPane.ERROR_MESSAGE);
				} else if (fechaInicio == null) {
					JOptionPane.showMessageDialog(frmPlanificarActividad,
							"La actividad no se ha creado. Debes introducir una fecha inicial de periodo.", "Error",
							JOptionPane.ERROR_MESSAGE);
				} else if (fechaFin == null) {
					JOptionPane.showMessageDialog(frmPlanificarActividad,
							"La actividad no se ha creado. Debes introducir una fecha final de periodo.", "Error",
							JOptionPane.ERROR_MESSAGE);
				}
				/*
				 * else if(esPrecio(textField_1.getText())) { // JOptionPane.showMessageDialog(
				 * frmPlanificarActividad,"La actividad no se ha creado. Debes introducir un precio de socio válido."
				 * ,"Error",JOptionPane.ERROR_MESSAGE); } else
				 * if(esPrecio(textField_2.getText())) { JOptionPane.showMessageDialog(
				 * frmPlanificarActividad,"La actividad no se ha creado. Debes introducir un precio de no socio válido."
				 * ,"Error",JOptionPane.ERROR_MESSAGE); }
				 */
				else if (fechaInicio.getTime() - fechaActual.getTime() < 0) {
					JOptionPane.showMessageDialog(frmPlanificarActividad,
							"La actividad no se ha creado. La fecha inicial es anterior a la actual.", "Error",
							JOptionPane.ERROR_MESSAGE);
				} else if (fechaFin.getTime() - fechaActual.getTime() < 0) {
					JOptionPane.showMessageDialog(frmPlanificarActividad,
							"La actividad no se ha creado. La fecha final es anterior a la actual.", "Error",
							JOptionPane.ERROR_MESSAGE);
					...
					String precioSocio = textField_2.getText();
					String precioNoSocio = textField_3.getText();
					...
					String per_ins_nombre = comboBox_2.getSelectedItem().toString();
					...
					long idActividad = ModeloActividades.nuevaActividadConId(nombre, descripcion, aforo, aforo,
							precioSocio, precioNoSocio, fechaInicioS, fechaFinS, deporte, instalacion, periodoIns);
					...
					JOptionPane.showMessageDialog(frmPlanificarActividad, "La actividad se ha creado correctamente",
