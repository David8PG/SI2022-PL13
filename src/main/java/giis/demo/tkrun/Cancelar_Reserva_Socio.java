...
public class Cancelar_Reserva_Socio {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Cancelar_Reserva_Socio window = new Cancelar_Reserva_Socio();
	 ...
	 */
	public Cancelar_Reserva_Socio() {
		initialize();
	}

	public Cancelar_Reserva_Socio(InicioSesion l) {
		login = l;
